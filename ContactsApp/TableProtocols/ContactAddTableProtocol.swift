...
class ContactAddTableProtocol: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func cellUpdations(cell: ContactAddEditCell, indexPath: IndexPath) {
        ...
        cell.firstText = { [weak self] (text) in
            ...
            strongSelf.newContact.first_name = text
        }
        cell.lastText = { [weak self] (text) in
            ...
            strongSelf.newContact.last_name = text
        }
        cell.mobileText = { [weak self] (text) in
            ...
            strongSelf.newContact.phone_number = text
        }
        cell.emailText = { [weak self] (text) in
            ...
            strongSelf.newContact.email = text
        }
